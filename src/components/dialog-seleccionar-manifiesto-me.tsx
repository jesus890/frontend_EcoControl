              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel
                      htmlFor="responsable0"
                      className="text-[13px] font-bold text-negrito"
                    >
                      Nombre del responsable que declara bajo protesta de decir verdad.
                    </FieldLabel>

                    <Input
                      id="responsable0"
                      type="text"
                      placeholder="Escriba el responsable que declara ..."
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel
                      ...
                      className="text-[13px] font-bold text-negrito"
                    >
                      Responsable de la recepción y transporte de los residuos (Transportista).
                    </FieldLabel>
